const rotationCalc = (delta, ref) => {
  ...
  ref[7].rotation.z += delta * (eRotation / 0.45);
  ref[8].rotation.y += delta * (eRotation / 0.72);
  ref[9].rotation.z += delta * (eRotation / 0.72);
  ref[10].rotation.y += delta * (eRotation / 0.67);
  ref[11].rotation.y += delta * (eRotation / 6.39);
};
